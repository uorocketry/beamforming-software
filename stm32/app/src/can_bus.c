...
#define CAN_GPIO_ALTERNATE_FUNCTION GPIO_AF4
#define CAN_FILTER_SELF_BANK 0u
#define CAN_FILTER_BROADCAST_BANK 1u
...
/*
 * The prioritized TX queue itself lives in can_tx_queue.c/h (host-testable,
 * no libopencm3). can_bus.c owns the bxCAN register/ISR integration around it:
